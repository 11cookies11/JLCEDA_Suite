...
- [x] L14 梳理 plugin 与 server 连接链路
- [x] L15 排查 plugin-server 通讯易断开问题
- [x] L16 重新打包插件与发布产物
- [x] L17 启动本地 bridge server
- [x] L18 重新打包含 heartbeat 修复的产物
- [x] L19 升级插件版本到 0.1.28
- [x] L20 测试原理图自动布局与自动连线
- [x] L21 实现 LED 指示灯小电路原理图
- [~] L22 修复小电路原理图完整构建能力

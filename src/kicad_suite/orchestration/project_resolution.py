...
from ..domain.core.parts.resolve import _as_string_list, _role_search_hints
from ..shared.schema_versions import PROJECT_RESOLUTION_SCHEMA_VERSION
from ..adapters.symbol_footprint_resolver import footprint_exists, symbol_mapping_for

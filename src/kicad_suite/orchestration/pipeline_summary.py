...
def build_run_pipeline_summary(
    *,
    ...
    project_resolution_result: dict[str, Any] | None,
    ...
    return {
        ...
        "files": {
            ...
            "placement_plan": (placement_result or {}).get("plan_file", ""),
            "placement_plan_report": (placement_result or {}).get("report_file", ""),
            ...
            "project_resolution": (project_resolution_result or {}).get("path", ""),
        ...
        "counts": {
            ...
            "project_resolution_search_queue": (project_resolution_result or {}).get("manifest", {}).get("summary", {}).get("search_queue_count", 0),
            "project_resolution_resolver_requests": (project_resolution_result or {}).get("manifest", {}).get("summary", {}).get("resolver_request_count", 0),
            "project_resolution_components": (project_resolution_result or {}).get("manifest", {}).get("summary", {}).get("component_count", 0),
            "project_resolution_verified": (project_resolution_result or {}).get("manifest", {}).get("summary", {}).get("verified_count", 0),
            "project_resolution_needs_reselection": (project_resolution_result or {}).get("manifest", {}).get("summary", {}).get("needs_reselection_count", 0),
            "placement_regions": (placement_result or {}).get("plan", {}).get("summary", {}).get("region_count", 0),
            "placement_components": (placement_result or {}).get("plan", {}).get("summary", {}).get("placed_count", 0),
            "placement_unassigned": (placement_result or {}).get("plan", {}).get("summary", {}).get("unassigned_count", 0),
        },
        "erc": {

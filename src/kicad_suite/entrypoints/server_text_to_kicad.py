...
from ..domain.core.compile_kicad_execution_plan import compile_plan, write_output
from ..shared.env_utils import env, is_truthy_env
from ..adapters.kicad_erc_runner import run as run_kicad_erc
...
from ..shared.schema_versions import TEXT_TO_KICAD_SUMMARY_SCHEMA_VERSION
...
def run() -> None:
    ...
    summary = {
        ...
        "diagnostics": {
            ...
            "simulation": {
                "profile": sim_result.get("profile", {}),
                "plan": sim_result.get("plan", {}),
            },
